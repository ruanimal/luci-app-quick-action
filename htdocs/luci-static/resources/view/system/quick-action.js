...
function getApiUsageHtml() {
	...
	return [
		...
		'<h4>Rate Limiting</h4>',
		'<p>Max 10 failed attempts per IP in 5 minutes. After exceeding the limit, all requests from that IP will be rejected.</p>',
		'<p>To reset rate limit: <code>rm /tmp/quick_action_rate_limit</code></p>',
		'<h4>Example (curl)</h4>',
